...
module.exports = {
  ...
  async getHistory({ homey }) {
    ...
    for (const entry of rawHistory) {
      // Skip history entries generated by condition cards
      if (entry.isCondition) continue;
      ...
      // Filter out condition card system prompts and JSON schema responses (fallback filter)
      if (text.includes('[CONDITION EVALUATION:') || text.includes('[SYSTEM: Based on your analysis above')) continue;
      if (role === 'model' && text.includes('"isAnswerable":')) continue;
